const TRANSLATIONS = {
    ...
    ru: {
        ...
        'success-p1': 'Ваш донат обрабатывается.<br>Я очень ценю вашу поддержку.',
        ...
        'terms-h-nature': 'Характер донатов',
        ...
        'terms-p-intro': 'Используя этот сайт и оставляя донат, вы принимаете настоящие Условия использования.',
        'terms-p-nature': 'Все платежи на этом сайте являются <strong>добровольными донатами</strong> в поддержку контента автора. Донаты не являются оплатой товаров, услуг, подписок или цифровых продуктов. Никакие товары, услуги или гарантированные привилегии не предоставляются в обмен на донат.',
        'terms-p-refund1': 'Донаты, как правило, <strong>не возвращаются</strong>.',
        'terms-p-refund2': 'После завершения транзакции донат не может быть отменён или возвращён, за исключением случаев, предусмотренных законодательством.',
        'terms-p-user': 'Вы несёте полную ответственность за правильное указание суммы и валюты перед подтверждением платежа.',
        'terms-p-content': 'Никнейм или сообщение, прилагаемые к донату, являются добровольными. Мы вправе удалить любой контент, который является оскорбительным, вводящим в заблуждение или неуместным.',
        'terms-p-3rdparty': 'Платежи обрабатываются защищённо через <strong>Stripe</strong>. Оставляя донат, вы также принимаете условия, политику и практику конфиденциальности Stripe.',
        ...
        'privacy-p-intro': 'Этот сайт позволяет оставлять <strong>добровольные донаты</strong>. Мы уважаем вашу приватность и собираем минимально необходимые данные.',
        ...
        'privacy-p-collect': 'При оставлении доната мы можем собирать:',
        'privacy-li-amount': 'Сумма и валюта доната',
        'privacy-li-nickname': 'Необязательный никнейм (если указан)',
        'privacy-li-message': 'Необязательное сообщение к донату',
        ...
        'privacy-li-use1': 'Обработка и учёт вашего доната',
        ...
        'privacy-li-legal1': 'Исполнение транзакции (обработка доната)',
        ...
        'privacy-p-retention': 'Записи о донатах хранятся только в течение времени, необходимого для бухгалтерских, юридических и целей безопасности. Необязательные данные (никнейм или сообщение) могут быть удалены по запросу.',
        ...
        'refund-p-intro': 'Этот сайт принимает только <strong>добровольные донаты</strong>. Донаты являются жестом поддержки и не являются оплатой товаров, услуг, подписок или цифровых продуктов.',
        'refund-p-general': 'Донаты, как правило, <strong>не возвращаются</strong>.',
        'refund-p-acknowledge': 'Совершая донат, вы подтверждаете и соглашаетесь:',
        'refund-li-optional': 'Донат является добровольным',
        'refund-li-chosen': 'Сумма доната выбирается вами',
        ...
        'refund-li-accidental': 'Случайный донат',
        ...
        'root-p3': 'Если вам нравится контент, вы можете оставить добровольный донат в поддержку моей работы. Донаты необязательны и не дают доступа к дополнительному контенту или услугам.',
        'root-cta': 'Оставить донат',
    },

    ua: {
        'page-title': 'Підтримати Ендрю',
        'back': '← Назад',
        'back-home': '← На головну',
        'back-try': '← Повернутись і спробувати знову',
        'last-updated': 'Останнє оновлення: <strong>Вересень 2025</strong>',

        'header-h1': 'Підтримати Ендрю',
        'subtitle': 'Сподобався контент?<br>Підтримай донатом.',
        ...
        'success-title': 'Дякую! 🙌',
        'success-p1': 'Ваш донат обробляється.<br>Я дуже ціную вашу підтримку.',
        ...
        'terms-h-nature': 'Характер донатів',
        ...
        'terms-p-intro': 'Використовуючи цей сайт і залишаючи донат, ви погоджуєтесь з цими Умовами використання.',
        'terms-p-nature': 'Усі платежі на цьому сайті є <strong>добровільними донатами</strong> на підтримку контенту автора. Донати не є оплатою товарів, послуг, підписок або цифрових продуктів. Жодні товари, послуги або гарантовані привілеї не надаються в обмін на донат.',
        'terms-p-refund1': 'Донати, як правило, <strong>не повертаються</strong>.',
        'terms-p-refund2': 'Після завершення транзакції донат не може бути скасований або повернений, окрім випадків, передбачених законодавством.',
        'terms-p-user': 'Ви несете повну відповідальність за правильне зазначення суми та валюти перед підтвердженням платежу.',
        'terms-p-content': 'Нікнейм або повідомлення до донату є добровільними. Ми залишаємо за собою право видалити будь-який контент, що є образливим, оманливим або неприйнятним.',
        'terms-p-3rdparty': 'Платежі обробляються захищено через <strong>Stripe</strong>. Залишаючи донат, ви також приймаєте умови, політику та практику конфіденційності Stripe.',
        ...
        'privacy-p-intro': 'Цей сайт дозволяє залишати <strong>добровільні донати</strong>. Ми поважаємо вашу приватність і збираємо лише мінімально необхідні дані.',
        'privacy-p-controller': 'Сайт управляється власником, який є контролером персональних даних, що збираються через цей сервіс.',
        'privacy-p-collect': 'При залишенні донату ми можемо збирати:',
        'privacy-li-amount': 'Сума та валюта донату',
        'privacy-li-nickname': 'Необов\'язковий нікнейм (якщо зазначено)',
        'privacy-li-message': 'Необов\'язкове повідомлення до донату',
        ...
        'privacy-li-use1': 'Обробка та облік вашого донату',
        ...
        'privacy-li-legal1': 'Виконання транзакції (обробка донату)',
        ...
        'privacy-p-retention': 'Записи про донати зберігаються лише стільки, скільки необхідно для бухгалтерських, юридичних та безпекових цілей. Необов\'язкові дані (нікнейм або повідомлення) можуть бути видалені на запит.',
        ...
        'refund-p-intro': 'Цей сайт приймає лише <strong>добровільні донати</strong>. Донати є жестом підтримки і не є оплатою товарів, послуг, підписок або цифрових продуктів.',
        'refund-p-general': 'Донати, як правило, <strong>не повертаються</strong>.',
        'refund-p-acknowledge': 'Здійснюючи донат, ви підтверджуєте та погоджуєтесь:',
        'refund-li-optional': 'Донат є добровільним',
        'refund-li-chosen': 'Сума донату обирається вами',
        ...
        'refund-li-accidental': 'Випадковий донат',
        ...
        'root-p3': 'Якщо вам подобається контент, ви можете залишити добровільний донат на підтримку моєї роботи. Донати є необов\'язковими і не дають доступу до додаткового контенту або послуг.',
        'root-cta': 'Залишити донат',
    }
};
